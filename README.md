...
Nesse projeto ***One For All***, foi usado **uma** tabela para revisar e consolidar **todos** os principais conceitos vistos no curso com SQL.

Foi recebido uma tabela não normalizada para ser normalizada e populada para que fosse possivel executar queries com o intuito de encontrar as informações solicitadas logo abaixo.
